...
def main():
    ...
    # Formulario en la barra lateral (Sidebar)
    ...
    # Botón para procesar el crédito
    if st.sidebar.button("Calcular Crédito"):
        if capital > 0 and tasa_anual > 0 and meses > 0:
            ...
            # --- GENERACIÓN DE TABLA DE AMORTIZACIÓN (Uso de Pandas) ---
            ...
            for mes in range(1, meses + 1):
                ...
                # Evitar pequeños residuos flotantes negativos al final
            ...
            # --- GRÁFICO INTERACTIVO (Uso de Plotly) ---
